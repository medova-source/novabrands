    ...
    <section className="bg-background">
      <div className="container-x py-24 md:py-32">
        ...
        <div className="mt-16 grid gap-px bg-[hsl(var(--rule))] md:grid-cols-2 lg:grid-cols-4">
          {[
            { icon: Truck, t: "Pick, Pack & Ship", d: "SLA backed fulfillment with branded inserts, custom poly mailers and ready for gifting presentation." },
            { icon: Boxes, t: "Inventory Management", d: "Lot tracked, expiry aware inventory with real time stock on hand and reorder alerts." },
      ...
      <div className="container-x grid gap-16 py-24 md:grid-cols-2 md:py-32">
        <Reveal>
          ...
          <p className="mt-5 max-w-md text-[15px] leading-relaxed text-muted-foreground">
            Smart fulfillment logic that routes by SKU, geography, carrier cost and inventory state. Set it once, and your operations run themselves.
          </p>
        ...
        <Reveal delay={0.1}>
          ...
          <p className="mt-5 max-w-md text-[15px] leading-relaxed text-muted-foreground">
            Native connections to the platforms you already sell on, with no custom dev work or brittle middleware.
          </p>
