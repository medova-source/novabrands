...
export const Gummies = () => (
  <FormatPage data={{
    ...
    customization: [
      ...
      { label: "Shape", description: "Custom 3D molds, including bears, hearts, branded geometries, layered and 3D forms." },
...
export const Capsules = () => (
  <FormatPage data={{
    ...
    description: "Vegetarian (HPMC), gelatin, liquid fill and beadlet capsules. From simple two piece encapsulation to delayed release and specialty multiple active formats.",
    heroImage: capsules,
    customization: [
...
export const Tablets = () => (
  <FormatPage data={{
    ...
    description: "Coated, layered, chewable, effervescent and orally disintegrating tablets. From high dose single active to multiple actives with proprietary release profiles.",
    heroImage: tablets,
    customization: [
...
export const Powders = () => (
  <FormatPage data={{
    format: "Powders",
    tagline: "Mixability you can taste.",
    ...
    customization: [
      ...
      { label: "Format", description: "Single serve sticks, multiple serve scoops, bulk pouches and jar systems." },
...
export const Liquids = () => (
  <FormatPage data={{
    ...
    description: "Aqueous and oil based liquid systems, including tinctures, shots, syrups, sprays and dropper bottles. Built to taste good, stay stable, and survive the supply chain.",
    heroImage: liquids,
    customization: [
