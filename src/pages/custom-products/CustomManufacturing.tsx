...
const CustomManufacturing = () => (
  <SiteLayout>
    <PageHero
      ...
      description="Whether you're recreating an existing product, scaling a beloved formula, or engineering something nobody has seen — Nova Brands runs it end-to-end."
    />
      ...
      <div className="container-x grid gap-12 py-24 md:grid-cols-12 md:py-32">
        ...
        <div className="md:col-span-6 md:pl-8 lg:pl-16 md:self-center">
          ...
          <div className="mt-10 grid gap-px bg-[hsl(var(--rule))]">
            {[
              { t: "New Product Development", d: "Build a formula from a clean sheet — actives, sensory and stability locked." },
              { t: "Match Existing Formula", d: "Reverse-engineer, source-substitute and optimize an existing SKU." },
              { t: "Commercialization & Quality Approval", d: "Spec lock, regulatory review and master batch record sign-off." },
            ].map((it, i) => (
    ...
    <ProcessGrid
      ...
      steps={[
        { num: "01", title: "Material Sourcing", description: "Vetted multi-source supply chain with identity, potency and contaminant testing." },
        ...
        { num: "04", title: "Quality Verification", description: "Third-party finished testing, COA generation and release-to-ship sign-off." },
      ]}
    />
