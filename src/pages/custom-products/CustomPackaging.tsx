...
const CustomPackaging = () => (
  <SiteLayout>
    <PageHero
      ...
      description="An internal packaging studio inside a manufacturing platform. Structural design, graphic design, sourcing, sampling and production, all vertically integrated with your formula."
      image={packaging}
    />
      ...
      <div className="container-x grid gap-12 py-24 md:grid-cols-12 md:py-32">
        ...
        <Reveal delay={0.1} className="md:col-span-7 md:pl-8 lg:pl-16">
          <p className="text-[15px] leading-relaxed text-muted-foreground">
            We've already done the supplier diligence so you don't have to. Multiple region sourcing, audited vendors, and unit economics that make your COGS work, without compromising the way the product feels in someone's hand.
          </p>
        </Reveal>
      </div>
    </section>
    ...
    <section className="border-t border-[hsl(var(--rule))] bg-secondary">
      <div className="container-x py-24 md:py-32">
        <Reveal><div className="eyebrow">Complete customization</div></Reveal>
        <Reveal delay={0.1}><h2 className="display-2 mt-6 max-w-3xl">Every surface. Every dimension. Every closure.</h2></Reveal>
        <div className="mt-16 grid gap-6 md:grid-cols-3">
          {[
            { icon: Palette, t: "Design & Material", d: "Glass, PCR, aluminum, paperboard, biofilm, with finishes from soft touch to mirror foil." },
    ...
    <section className="border-t border-[hsl(var(--rule))] bg-background">
      <div className="container-x py-24 md:py-32">
        ...
        <div className="mt-16 grid gap-px bg-[hsl(var(--rule))] md:grid-cols-2 lg:grid-cols-3">
          {[
            { icon: Layers, t: "Graphic Design", d: "Brand led design, including typography, illustration, photography direction." },
